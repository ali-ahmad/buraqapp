...
GnuBook.prototype.prepareTwoPageView = function(centerPercentageX, centerPercentageY) {
    ...
    $(this.twoPage.coverDiv).attr('id', 'GBbookcover').css({
        border: '1px solid #657E20',
        width:  this.twoPage.bookCoverDivWidth + 'px',
        height: this.twoPage.bookCoverDivHeight+'px',
        visibility: 'visible',
        position: 'absolute',
        backgroundColor: '#657E20',
    ...
    $(div).attr('id', 'GBbookspine').css({
        border:          '1px solid #657F1E',
        width:           this.twoPage.bookSpineDivWidth+'px',
        height:          this.twoPage.bookSpineDivHeight+'px',
        position:        'absolute',
        backgroundColor: '#657F1E',
...
GnuBook.prototype.initToolbar = function(mode) {
    ...
    $("#GnuBook").append("<div id='GBheader'>"
        + "<a class='GBicon logo rollover' href='http://www.loc.gov'>&nbsp;</a>"
        + "<a class='GBicon rollover book_dept' href='/'>&nbsp;</a>"
    ...
    jToolbar.append("<div id='GBtoolbarbuttons'>"
        + "<button class='GBicon rollover cover_mode' onclick='gb.switchMode(1); gb.first(); return false;'/>"
